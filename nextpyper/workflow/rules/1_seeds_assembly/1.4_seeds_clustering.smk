...
rule seeds_collection:
    ...
    output:
        ...
        saute_params=expand(outdir / "saute/params/{sample}.json", sample=sample_list),
    params:
        min_sister_freq=min_sister_sample_freq,
        pattern=pattern,
        is_multi=multi_probes,
        primary_target_depth=primary_target_depth,
        secondary_target_depth=secondary_target_depth,
    # log:
    #     expand(
