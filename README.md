...
This command creates the required environments within NextPyper's installation path. You can use the option `--conda-prefix` to specify a different path where to store these environments.
...
For multi-probes, specify the appropriate pattern as well:
